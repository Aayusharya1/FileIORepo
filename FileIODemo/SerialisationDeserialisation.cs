...
namespace FileIODemo
{
    ...
    {
        public string path = @"C:\Users\Aayush Arya\source\repos\FileIODemo";
        ...
        public void XMLSerialize()
        {
            ...
            FileStream fileStream = new FileStream(@"C:\Users\Aayush Arya\source\repos\FileIODemo\FileIODemo\xmlSerialize.txt", FileMode.Create);
        ...
        {
            XmlSerializer xmlSerializer = new XmlSerializer(typeof(OrderForm));
            FileStream fileStream = new FileStream(@"C:\Users\Aayush Arya\source\repos\FileIODemo\FileIODemo\xmlSerialize.txt", FileMode.Open);
